...
function fillEditUserFieldsFromEmployee($form, $selectedOption) {
...
$(document).on('change', '#editUserForm #employee_id', function () {
    var $select = $(this);
    ...
    fillEditUserFieldsFromEmployee($form, $selectedOption);
});
