...
class AnnualActivityCalendarExport implements FromView, WithEvents
{
    ...
    {
        return view('planning::reports.exports.annual-excel', [
            'rows' => $this->rows,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event): void {
                ...
                $sheet->setTitle('ផែនការប្រចាំឆ្នាំ');
                ...
                foreach (range(2, 5) as $columnIndex) {
                ...
                $sheet->getStyle('A' . $firstDataRow . ':A' . $lastTableRow)->getFont()->setName('Khmer OS Siemreap')->setSize(10);
                $sheet->getStyle('A' . $firstDataRow . ':A' . $lastTableRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_TOP)->setWrapText(true);
                $sheet->getStyle('B' . $firstDataRow . ':E' . $lastTableRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
                $sheet->getStyle('F' . $firstDataRow . ':F' . $lastTableRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
