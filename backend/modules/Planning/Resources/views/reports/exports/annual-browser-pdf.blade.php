...
<head>
    <meta charset="UTF-8">
    <title>របាយការណ៍ប្រចាំឆ្នាំ</title>
    @php
...
<table class="header-table">
    ...
    <tr><td class="org-block org-title-font">@foreach (($orgHeaderLines ?? [$reportOrgName]) as $line)<div @if(!$loop->first) style="margin-top: 6px;" @endif>{{ $line }}</div>@endforeach</td><td style="padding-left: 40px;" class="nation-line">ជាតិ សាសនា ព្រះមហាក្សត្រ</td></tr>
</table>
<div class="page-title">ផែនការសកម្មភាពប្រចាំឆ្នាំ ឆ្នាំ {{ $khmerYear }}</div>
<table class="report-table">
    ...
    @forelse ($groupedRows as $indicatorLabel => $indicatorRows)
        ...
        @endforeach
    @empty
        <tr><td colspan="{{ 5 + $timelineQuarters->count() }}" style="text-align: center;">មិនមានរបាយការណ៍ផែនការសកម្មភាពប្រចាំឆ្នាំទេ។</td></tr>
    @endforelse
    </tbody>
</table>
