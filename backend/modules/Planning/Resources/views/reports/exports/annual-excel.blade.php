...
<table>
    ...
    <tr><td colspan="9" style="text-align: center;">ផែនការសកម្មភាពប្រចាំឆ្នាំ ឆ្នាំ {{ $khmerYear }}</td></tr>
    <tr><td colspan="9"></td></tr>
    <tr>
        ...
        @endforeach
        <td style="text-align: center; border: 1px solid #000000;">ចំនួនខែ</td>
    ...
    @forelse ($groupedRows as $indicatorLabel => $indicatorRows)
        ...
        @foreach ($indicatorRows as $row)
            <tr>
                ...
                @endforeach
                <td style="text-align: center; border: 1px solid #000000;">{{ $row->months_count }}</td>
        ...
        @endforeach
    @empty
        <tr><td colspan="9" style="text-align: center; border: 1px solid #000000;">មិនមានរបាយការណ៍ផែនការសកម្មភាពប្រចាំឆ្នាំទេ។</td></tr>
    @endforelse
</table>
