...
class AttendanceGovernanceSeeder extends Seeder
{
    public function run(): void
    {
        foreach ((array) config('attendance_governance.templates', []) as $template) {
            DB::table('attendance_responsibility_templates')->updateOrInsert(
        ...
        foreach ((array) config('attendance_governance.workflow_policies', []) as $policy) {
            DB::table('attendance_workflow_policies')->updateOrInsert(
