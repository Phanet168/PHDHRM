...
<div class="modal fade" id="update-department-{{ $department->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="orgSubUnitEditForm" action="{{ route('departments.update', $department->uuid) }}" method="POST"
                                ...
                                <select name="parent_id" class="form-select js-parent-unit-select">
                                    ...
                                    @foreach ($parent_units as $parent_unit)
                                        <option value="{{ $parent_unit->id }}" title="{{ $parent_unit->path }}"
                                            ...
                                            {{ $parent_unit->id == $department->parent_id ? 'selected' : '' }}>
                                            {{ $parent_unit->label }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary submit_button" id="org_sub_unit_update_submit">{{ localize('save') }}</button>
                </div>
            </form>
        </div>
    </div>
