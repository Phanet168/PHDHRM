...
@section('title', localize('incoming_letters', 'Incoming letters'))
    ...
    <div class="body-content">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                <h6 class="mb-0">{{ localize('incoming_letters', 'Incoming letters') }}</h6>
                    ...
                    <table class="table table-bordered table-striped mb-0 align-middle">
                        <thead>
                            <tr>
                                ...
                                <th>{{ localize('received_date', 'Received date') }}</th>
                        ...
                        <tbody>
                            @forelse ($letters as $index => $letter)
                                <tr>
                                    ...
                                    <td>{{ $letter->from_org ?: '-' }}</td>
                                    <td>{{ optional($letter->received_date)->format('d/m/Y') ?: '-' }}</td>
                                    <td>{{ $letter->status }}</td>
