...
@if (app()->getLocale() === 'km')
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Noto+Sans+Khmer:wght@300;400;500;600;700&family=Kantumruy+Pro:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
    <link href="{{ asset('backend/assets/dist/css/khmer-font.css') }}" rel="stylesheet" />
@endif
